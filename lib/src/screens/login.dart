            ...
            child: Form(
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Icon(Icons.local_post_office_outlined,color: Colors.white),
                  ...
                  Text('Esqueci minha senha', style: customTheme.primaryTextTheme.headline6),
                  Align(
                    alignment: Alignment.bottomCenter,
                    child:
                      Text('Cadastrar-se', style: TextStyle(color:Colors.white,fontSize: 20,)) ,
                  )
                ],
              ),
            ),
